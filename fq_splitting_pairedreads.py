...
# date: 2022-02-07
Description: extract paired reads and orphan reads from Forward and Reverse fastq files, respectively.

Usage: 
python fq_splitting_pairedreads.py forward.fq reverse.fq  

forward.fq = LEFT  fastq or fastq.gz file (R1)
reverse.fq = RIGHT fastq or fastq.gz file (R2)
